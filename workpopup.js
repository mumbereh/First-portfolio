...
const popupInfo = [
  {
    ...
    year: '2015',
    popupPhoto: 'images/Snapshootpopup1.svg',
...

  {
    ...
    backend: 'Back End Dev',
    year: '2015',
    popupPhoto: 'images/Snapshootpopup2.svg',
    content: 'Lorem Ipsum is dummy text of the printing and typesetting industry. Lorem Ipsum has been the industrys standard dummy text since the 1500s when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries.',
    tools: ['HTML', 'CSS', 'JavaScript', 'Ruby', 'Bootstrap'],
  },

  {
    ...
    backend: 'Back End Dev',
    year: '2015',
    popupPhoto: 'images/Snapshootpopup3.svg',
    content: 'Lorem Ipsum is dummy text of the printing and typesetting industry. Lorem Ipsum has been the industrys standard dummy text since the 1500s when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries.',
    tools: ['HTML', 'CSS', 'JavaScript', 'Ruby', 'Bootstrap'],
  },

  {
    ...
    backend: 'Back End Dev',
    year: '2015',
    popupPhoto: 'images/Snapshootpopup4.svg',
    content: 'Lorem Ipsum is dummy text of the printing and typesetting industry. Lorem Ipsum has been the industrys standard dummy text since the 1500s when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries.',
    tools: ['HTML', 'CSS', 'JavaScript', 'Ruby', 'Bootstrap'],
  },
];
...
<div class="card-body">
  ...
  <div>
    ...
    <ul class="card-sub">
      ...
      <div class="bullet-point"><img src="images/Counter.svg" alt="Bullet Point"></div>
    ...
    popUp.innerHTML = `
        ...
        <div class="modal-body">
          <div class="modal-title">
            ...
            <i id="modal-close" class="uil uil-multiply"><img src="images/cross.png"></i>
            <ul class="card-sub">
